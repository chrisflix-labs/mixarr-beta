...
Current release: **v2.4.9 — AI Governance, Security and Reliability**. See [the v2.4.9 guide](docs/AI_GOVERNANCE_SECURITY_RELIABILITY_V249.md) for least-privilege permissions, provider/model allowlists, external-data controls, response quarantine, retention, durable jobs, and emergency shutdown.
