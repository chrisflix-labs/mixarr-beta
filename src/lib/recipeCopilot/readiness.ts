...
const messages: Record<string, string> = {
  ...
  AI_PROVIDER_TRUNCATED_BEFORE_FINAL: "The AI provider used the output allowance before producing a final answer.",
  AI_PROVIDER_TRUNCATED_FINAL_RESPONSE: "The AI provider reached the output allowance while producing the final answer.",
