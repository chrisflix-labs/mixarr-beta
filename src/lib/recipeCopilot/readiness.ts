...
const messages: Record<string, string> = {
  ...
  AI_PROVIDER_TRUNCATED_BEFORE_FINAL: "The AI provider stopped before producing a final answer.",
  AI_PROVIDER_TRUNCATED_FINAL_RESPONSE: "The AI provider stopped while producing the final answer.",
  AI_PROVIDER_TRUNCATED_RESPONSE: "The AI provider stopped before returning a complete final answer.",
  AI_PROVIDER_INVALID_STRUCTURED_RESPONSE: "The AI provider completed normally, but returned invalid structured output.",
  AI_PROVIDER_INVALID_RESPONSE: "The AI provider returned a response that could not be converted into a valid recipe.",
  AI_FEATURE_INVALID_JSON_OUTPUT: "The AI provider returned text instead of JSON.",
  AI_FEATURE_INVALID_STRUCTURED_OUTPUT: "The AI provider responded successfully, but the draft did not match the Recipe Copilot format.",
  AI_FEATURE_TRUNCATED_STRUCTURED_OUTPUT: "The provider stopped before returning a complete Recipe Copilot draft.",
  AI_FEATURE_EMPTY_OUTPUT: "The provider returned no final Recipe Copilot content.",
  AI_FEATURE_STRUCTURED_REPAIR_FAILED: "An automatic format repair was attempted but did not succeed.",
