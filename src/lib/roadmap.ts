...
export const roadmapReleases: RoadmapRelease[] = [
  ...
  ...[
    ...
    featureLabels: [], releaseOrder: 207 + index,
  })),
];
...
export const roadmapCycles: RoadmapCycle[] = [
  ...
  },
  {
    ...
    status: "current",
    description: "v2.2.0 established deterministic playlist orchestration, v2.2.1 added reusable collections, v2.2.2 added cross-playlist variety, v2.2.3 added multi-playlist journeys, v2.2.4 added explainable Smart Refresh Scheduling, v2.2.5 added Library Coverage & Rotation Intelligence, and v2.2.6 adds protected Smart Mix experiments. Later optional AI-assisted planning remains a separate future possibility, never a core dependency.",
