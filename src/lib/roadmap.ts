...
export const roadmapCycles: RoadmapCycle[] = [
  ...
  },
  {
    ...
    status: "current",
    description: "The provider foundation, centralized governance controls, review-first natural-language workflow, and native OpenAI compatibility hotfix are available through v2.4.3. AI interprets intent while deterministic Mixarr code remains authoritative for track selection and Plex changes.",
