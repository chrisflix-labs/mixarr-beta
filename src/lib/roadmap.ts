...
export const roadmapCycles: RoadmapCycle[] = [
  ...
  },
  {
    ...
    status: "current",
    description: "The provider foundation, centralized governance controls, and review-first natural-language request workflow are available through v2.4.2. AI interprets intent while deterministic Mixarr code remains authoritative for track selection and Plex changes.",
