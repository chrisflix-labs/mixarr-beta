...
export const roadmapCycles: RoadmapCycle[] = [
  ...
  },
  {
    ...
    futureThemes: ["Recipe export and import refinements", "Built-in templates", "Recipe sharing and community catalogs", "Recipe comparison", "Recipe history and rollback", "Recipe inheritance", "Recipe scheduling", "Recipe recommendations", "Optional AI-assisted recipe creation"],
  },
  {
    id: "future-2x",
