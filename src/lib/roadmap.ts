...
export const roadmapCycles: RoadmapCycle[] = [
  ...
  },
  {
    ...
    status: "current",
    description: "The provider foundation, governance controls, natural-language workflow, Recipe Copilot, local-first intent intelligence, playlist summaries, and advisory metadata suggestions are available through v2.4.6. Intelligence interprets and proposes while deterministic Mixarr code remains authoritative and metadata suggestions cannot write changes.",
