...
export const roadmapCycles: RoadmapCycle[] = [
  ...
  },
  {
    ...
    status: "current",
    description: "The provider foundation and centralized governance controls are available through v2.4.1. User-facing assistance remains future work and no current AI path can mutate a playlist.",
