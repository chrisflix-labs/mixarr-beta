...
export const roadmapReleases: RoadmapRelease[] = [
  ...
  },
  {
    ...
    cycle: "2.3.x",
    status: "completed",
    description: "Makes Mixarr a safer, observable participant in the wider media ecosystem with Plex ownership and collections, external-change reconciliation, scan and mount safeguards, notifications, signed events, scoped APIs, and monitoring endpoints.",
    featureLabels: ["Plex server health", "Plex user mapping", "Playlist ownership", "Plex collections", "Manual-change reconciliation", "Scan safety", "Mount safety", "Tautulli", "Discord recipe sharing", "Notifiarr", "Signed webhooks", "Homepage widget", "Home Assistant", "Prometheus", "Scoped API tokens", "Health endpoints", "Integration tests"],
    releaseOrder: 307,
    completionDate: "2026-07-19",
  ...
  },
  {
    ...
    cycle: "2.4.x",
    status: "completed",
    description: "Adds centralized privacy transformation, decimal-safe model pricing, transactional in-flight budget reservations, user/provider/global cost and request limits, model context safety, background and retry cost policy, alerts, previews, and a sanitized usage dashboard before any user-facing AI workflow is enabled.",
    featureLabels: ["Local Only", "Metadata Limited", "Anonymous Metadata", "Full Metadata acknowledgment", "Model pricing", "Budget reservations", "Global/provider/user cost limits", "Request-count limits", "Model context safety", "Context trimming", "Background controls", "Retry cost protection", "Cost preview", "Metadata preview", "Provider comparison", "Usage analytics", "Governance audit", "Safe upgrade defaults"],
    releaseOrder: 401,
    releaseType: "patch",
    progress: 100,
    completionDate: "2026-07-20",
  ...
  },
  {
    ...
    cycle: "2.4.x",
    status: "completed",
    description: "Turns ordinary-language playlist intent into a transparent, editable, schema-valid recipe draft with local entity resolution, deterministic analysis and preview, and revision-bound explicit approval.",
    featureLabels: ["Ask Mixarr", "Structured interpretation", "Explicit vs inferred constraints", "Assumptions and ambiguities", "Conversational revisions", "Recipe Studio integration", "Deterministic preview", "Approval invalidation", "Privacy and cost preflight", "No pre-approval Plex mutation"],
    releaseOrder: 402,
    releaseType: "patch",
    progress: 100,
    completionDate: "2026-07-20",
  ...
  },
  {
    ...
    cycle: "2.4.x",
    status: "completed",
    description: "Repairs native OpenAI inference tests with the Responses API, compatible-model selection, cause-specific diagnostics, and separate credential, discovery, and inference health.",
    featureLabels: ["Native OpenAI adapter", "Responses API", "Model compatibility", "Test model selector", "Sanitized diagnostics", "Provider request IDs", "Separate health dimensions", "Accurate cost states"],
    releaseOrder: 403,
    releaseType: "patch",
    progress: 100,
  ...
  },
  {
    ...
    cycle: "2.4.x",
    status: "completed",
    description: "Adds a review-first Recipe Copilot to create, refine, explain, diagnose, compare, and optimize canonical recipes while preserving privacy, governance, validation, approval, revisions, and deterministic execution.",
    featureLabels: ["Recipe Copilot", "Structured recipe drafts", "Reviewable diffs", "Intent conflicts", "Candidate estimates", "Parent recommendations", "Inheritance guidance", "Diagnosis", "Optimization", "AI provenance", "Quarantine", "No automatic activation"],
    releaseOrder: 404,
    releaseType: "patch",
    progress: 100,
    completionDate: "2026-07-21",
  ...
  },
  {
    ...
    cycle: "2.4.x",
    status: "completed",
    description: "Adds local-first structured playlist intent, editable phases, emotional progression, energy and BPM curves, preferences, requirements, conflicts, private terminology, presets, and a deterministic engine adapter.",
    featureLabels: ["Local intent parser", "Mood and activity", "Time of day", "Editable phases", "Energy curves", "BPM curves", "Hard vs soft", "Conflict detection", "Personal dictionary", "Intent presets", "Local-first privacy", "Deterministic selection"],
    releaseOrder: 405,
    releaseType: "patch",
    progress: 100,
    completionDate: "2026-07-21",
  ...
  },
  {
    ...
    cycle: "2.4.x",
    status: "completed",
    description: "Adds privacy-scoped factual playlist summaries and reviewable metadata cleanup suggestions with evidence, deduplication, safe bulk decisions, and a hard no-write boundary.",
    featureLabels: ["Playlist summaries", "Refresh comparisons", "Plex-friendly copy", "Metadata suggestions", "Source evidence", "Confidence levels", "Bulk review", "Ignore rules", "CSV and JSON", "Token-aware batches", "Approved not applied", "No metadata writes"],
    releaseOrder: 406,
    releaseType: "patch",
    progress: 100,
    completionDate: "2026-07-21",
    route: "/ai/metadata-suggestions",
  },
  {
    version: "2.4.7",
    ...
    cycle: "2.4.x",
    status: "completed",
    description: "Connects immutable user intent, structured AI interpretation, generated recipe fields, deterministic validation and track decisions, responsibility labels, exports, and reproducibility without extra AI calls.",
    featureLabels: ["Five explanation layers", "Request-to-rule trace", "Rule-to-track trace", "Responsibility labels", "AI confidence", "Assumptions", "Alternatives", "Semantic diffs", "Household notes", "Privacy-aware export", "Reproducibility", "Deterministic selection"],
    releaseOrder: 407,
    releaseType: "patch",
    progress: 100,
  ...
  },
  {
    ...
    cycle: "2.4.x",
    status: "completed",
    description: "Adds deterministic-first diagnostics, explicit privacy selection, sanitized previews, optional governed AI explanations, safe what-if simulations, and individually approved actions.",
    featureLabels: ["Troubleshooting Center", "Diagnostic privacy", "Secret sanitization", "Deterministic findings", "Candidate funnel", "AI explanations", "What-if simulations", "Suggestion review", "Stale checks", "Audit history", "Sanitized export", "No automatic changes"],
    releaseOrder: 408,
    releaseType: "patch",
    progress: 100,
    completionDate: "2026-07-22",
  ...
  },
  {
    ...
    cycle: "2.4.x",
    status: "completed",
    description: "Adds deny-by-default permissions and allowlists, external-data governance, centralized prompt and response security, quarantine, retention, durable AI jobs, and emergency shutdown.",
    featureLabels: ["Granular AI permissions", "Provider approvals", "Model allowlists", "External data controls", "Central redaction", "Injection detection", "Response quarantine", "Retention policy", "Durable queue", "Concurrency limits", "Emergency shutdown", "Local-only tests"],
    releaseOrder: 409,
    releaseType: "patch",
    progress: 100,
    completionDate: "2026-07-22",
  ...
  },
  {
    ...
    cycle: "2.4.x",
    status: "current",
    description: "Adds a scoped, portable backup and restore for calculated library intelligence — audio features, BPM, popularity, genres, and their processing and no-data states — so a recreated database can be restored without rerunning tens of thousands of analysis and lookup jobs. Excludes settings, accounts, tokens, AI data, logs, and playlists.",
    featureLabels: ["Scoped library-intelligence backup", "Versioned portable archive", "Streaming batched export", "Checksum verification", "Guided restore preview", "Conservative deterministic matching", "Fill Missing / Prefer Backup / Keep Current", "Known no-data preservation", "Deferred restore before Plex sync", "Idempotent resumable apply", "Restore provenance", "Admin-only permissions", "Untrusted-archive security", "Docker backup volume guidance"],
    releaseOrder: 411,
    releaseType: "patch",
    progress: 100,
    completionDate: "2026-07-22",
    route: "/settings/system/library-backup",
  },
  {
    version: "2.4.10",
    ...
    cycle: "2.4.x",
    status: "completed",
    description: "Unifies the complete v2.4.x AI system through guided setup, trustworthy operational summaries, request and recipe history, templates, provider and model guidance, privacy and cost review, feedback, household-safe access, accessibility, reliability, and documentation polish.",
    featureLabels: ["Unified AI center", "Resumable onboarding", "Provider and model guidance", "Privacy payload preview", "Backend cost limits", "Request history", "Saved templates", "Recipe review", "Metadata center", "Explanation center", "Usage and audit", "Quality feedback", "Household permissions", "Mobile and keyboard access", "Queue and security hardening", "Migration and documentation"],
    releaseOrder: 410,
    releaseType: "patch",
    progress: 100,
    completionDate: "2026-07-22",
...
export const roadmapCycles: RoadmapCycle[] = [
  ...
  },
  {
    ...
    status: "current",
    description: "The provider foundation, governance controls, natural-language workflow, Recipe Copilot, local-first intent intelligence, playlist summaries, advisory metadata suggestions, explainable recommendations, and deterministic-first troubleshooting are available through v2.4.8. Intelligence interprets and proposes while deterministic Mixarr code remains authoritative.",
