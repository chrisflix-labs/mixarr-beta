...
export const roadmapReleases: RoadmapRelease[] = [
  ...
  ...[
    ...
    featureLabels: [], releaseOrder: 205 + index,
  })),
];
...
export const roadmapCycles: RoadmapCycle[] = [
  ...
  },
  {
    ...
    status: "current",
    description: "v2.2.0 established deterministic playlist orchestration, v2.2.1 added reusable playlist collections, v2.2.2 added local cross-playlist variety, v2.2.3 added multi-playlist journeys, and v2.2.4 adds explainable, estimate-gated Smart Refresh Scheduling. Later automation and optional AI-assisted planning can build on this deterministic foundation without making an AI provider a dependency.",
