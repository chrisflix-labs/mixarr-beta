...
export const roadmapReleases: RoadmapRelease[] = [
  ...
  ...[
    ["2.2.2", "Cross-Playlist Duplicate Control"],
    ...
    featureLabels: [], releaseOrder: 202 + index,
  })),
];
...
export const roadmapCycles: RoadmapCycle[] = [
  ...
  },
  {
    ...
    status: "current",
    description: "v2.2.0 established deterministic playlist orchestration and v2.2.1 adds reusable playlist collections, runtime inheritance, group health, and bounded regeneration. Later v2.2.x releases may add richer cross-playlist behavior without making generative AI a dependency.",
