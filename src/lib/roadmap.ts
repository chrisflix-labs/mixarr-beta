...
export const roadmapCycles: RoadmapCycle[] = [
  ...
  },
  {
    ...
    status: "current",
    description: "The provider foundation, centralized governance controls, natural-language workflow, Recipe Copilot, and local-first mood, activity, and intent intelligence are available through v2.4.5. Intelligence interprets and proposes while deterministic Mixarr code remains authoritative for validation, track selection, approval, and Plex changes.",
