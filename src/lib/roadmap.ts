...
export const roadmapCycles: RoadmapCycle[] = [
  ...
  },
  {
    ...
    status: "current",
    description: "The provider foundation, centralized governance controls, natural-language workflow, native OpenAI compatibility, and review-first Recipe Copilot are available through v2.4.4. AI interprets and proposes while deterministic Mixarr code remains authoritative for validation, track selection, approval, and Plex changes.",
