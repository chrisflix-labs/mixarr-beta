...
export const roadmapReleases: RoadmapRelease[] = [
  ...
  },
  {
    ...
    cycle: "2.4.x",
    status: "completed",
    description: "Adds centralized privacy transformation, decimal-safe model pricing, transactional in-flight budget reservations, user/provider/global limits, token and context controls, background and retry cost policy, alerts, previews, and a sanitized usage dashboard before any user-facing AI workflow is enabled.",
    featureLabels: ["Local Only", "Metadata Limited", "Anonymous Metadata", "Full Metadata acknowledgment", "Model pricing", "Budget reservations", "Global/provider/user limits", "Token limits", "Context trimming", "Background controls", "Retry cost protection", "Cost preview", "Metadata preview", "Provider comparison", "Usage analytics", "Governance audit", "Safe upgrade defaults"],
    releaseOrder: 401,
    releaseType: "patch",
    progress: 100,
    completionDate: "2026-07-20",
