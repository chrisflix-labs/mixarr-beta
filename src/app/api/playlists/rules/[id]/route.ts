    ...
    const rule = await prisma.playlistRule.update({
      ...
      data: {
        ...
        optionsJson: JSON.stringify({
          ...
          smartPresetId: parsed.smartPresetId,
          smartPresetName: parsed.smartPresetName,
          smartPresetVersion: parsed.smartPresetVersion,
          moodPresetId: parsed.moodPresetId,
          moodPresetName: parsed.moodPresetName,
          moodPresetVersion: parsed.moodPresetVersion,
          moodPresetModified: parsed.moodPresetModified,
