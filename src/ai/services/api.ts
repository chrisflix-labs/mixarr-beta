...
export function aiRouteError(error: unknown) {
  ...
  return NextResponse.json({ error: { code: "INTERNAL_AI_ERROR", message: "The AI settings request could not be completed." }, code: "INTERNAL_AI_ERROR", message: "The AI settings request could not be completed." }, { status: 500 });
}
